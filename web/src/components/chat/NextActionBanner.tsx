...
export default function NextActionBanner({ text, onContinue }: NextActionBannerProps) {
  ...
  return (
    <div className="flex items-center gap-3 px-4 py-3 bg-gradient-to-r from-[#e7f7f1] via-[#ebf5f8] to-[#f1f5f8] border-b border-[#d3e8e2]">
      <span className="text-base text-teal-800 flex-1">
